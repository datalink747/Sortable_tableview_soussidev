...
public interface OnScrollListener {
    void onScrollStateChanged(RecyclerView tableDateView, ScrollState scrollState);
     ...
     * @param totalItemCount   The number of items in the
     */
    ...
    void onScroll(RecyclerView tableDataView, int firstVisibleItem, int visibleItemCount, int totalItemCount);
